    ...
    <div className="min-h-screen flex bg-background">
      <div className="hidden lg:flex lg:flex-1 bg-linear-to-br from-primary to-green-800 flex-col justify-between p-12">
        ...
        <div>
          ...
          <cite className="text-white/60 text-sm">— J.R.R. Tolkien</cite>
        </div>
        <div className="text-white/40 text-sm">Organiza tu mundo literario</div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-muted-foreground text-sm mb-8">
            Empieza a organizar tu colección de libros
          </p>
